...
const { site } = require("./utils/logger");
...
module.exports = function server(client) {
    ...
    function logoutAndError(err, req, res, next) {
        ...
        res.render("src/pages/500", { user: null, error: "An unexpected error happened. You've been automatically logged out." });
    }
    ...
    app.listen(port, function () {
        site('Server listening on port ' + port + '…');
    });
}