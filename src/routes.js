...
module.exports = function (app, client) {
    ...
    app.get("/public/resources/css/style.css", (req, res) => {
        let file = readFileSync("./src/public/resources/css/main.css").toString();
    ...
    app.get("/public/resources/css/switch.css", (req, res) => {
        let file = readFileSync("./src/public/resources/css/switch.raw.css").toString();
        file = file.split(constant).join(color);
        res.header("content-type", "text/css").send(file);
    });
    app.get("/public/resources/assets/wave.svg", (req, res) => {
        let color = `#${client.color.toString(16).toUpperCase()}`;
        let file = readFileSync("./src/public/resources/assets/wavy-color-by-nouridio.svg").toString();
