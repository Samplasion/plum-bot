...
module.exports = class ImageCommand extends Command {
	constructor(client, opts) {
        ...
        opts.details = opts.details || oneLine`This command gets the image
